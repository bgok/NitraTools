...
function firebugFrameLoad(Firebug)
{
    ...
    // * NitraTools; is unique prefix of all messages that should be customized.
    // * DBG_NITRATOOLS is a class name with style defined in the specified stylesheet.
    Firebug.registerTracePrefix("NitraTools;", "DBG_NITRATOOLS", true,
        "chrome://nitratools/skin/nitratools.css");
    ...
    var config = {id: "NitraTools@cobaltgroup.com"};
    Firebug.registerExtension("nitratools", config);
}
...
function firebugFrameUnload(Firebug)
{
    ...
    Firebug.unregisterExtension("nitratools");
    Firebug.unregisterTracePrefix("NitraTools;");
}
